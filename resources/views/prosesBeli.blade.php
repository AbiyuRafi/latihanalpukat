            ...
            <div class="slider">
                <div class="sliderWrapper">
                    <div class="sliderItem">
                        ...
                        <i class='bx bxs-star' style="color:yellow"></i><i class='bx bxs-star' style="color:yellow"></i><i
                            class='bx bxs-star' style="color:yellow"></i><i class='bx bxs-star' style="color:yellow"></i><i
                            class='bx bxs-star-half' style="color:yellow"></i>
                        <div class="container">
                        ...
                        <div class="model-container">
                            <div class="model">
                                ...
                                <form action="prosesBeli_cekout" method="post">
                                    ...
                                    <p style="margin-bottom:30px">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                        Eos, quod?</p>
                                    <button>Beli</button>
